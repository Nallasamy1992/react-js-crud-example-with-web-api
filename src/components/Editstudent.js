...
import '../components/Addstudet.css'
class Edit extends React.Component {
    ...
    componentDidMount() {
        axios.get('http://localhost:60540/Api/Student/StudentdetailById?id=' + this.props.match.params.id)
            .then(response => {
                this.setState({
    ...
    onSubmit(e) {
      ...
      //  this.props.onLoadUsersClick();
        axios.post('http://localhost:60540/Api/Student/AddotrUpdatestudent/', obj)
